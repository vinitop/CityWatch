...
window = tk.Tk()
window.title("City Watch- Shruti Vinit Aayush Akshay Anurag")
...
label_title = tk.Label(frame1, text="City Watch")
...
btn1 = tk.Button(frame1, text='Anti- Theft', height=90, width=180, fg='green',command = find_motion, image=btn1_image, compound='left')
btn1['font'] = btn_font
btn1.grid(row=3, pady=(20,10))

btn2 = tk.Button(frame1, text='Trespassing', height=90, width=180, fg='orange', command=rect_noise, compound='left', image=btn2_image)
btn2['font'] = btn_font
...
btn6 = tk.Button(frame1, text='Face Entry', height=90, width=180, fg='green', command=in_out, image=btn6_image, compound='left')
btn6['font'] = btn_font
