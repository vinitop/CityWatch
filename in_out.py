        ...
        if right == "" and left == "":
            if x > 500:
                ...
                if x < 200:
                    ...
                    x = 300
                    right, left = "", ""
                    cv2.imwrite(f"visitors/in/{datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S.%f')}.jpg", frame1)
                ...
                if x > 500:
                    ...
                    x = 300
                    right, left = "", ""
                    cv2.imwrite(f"visitors/out/{datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S.%f')[:-3]}.jpg", frame1)
